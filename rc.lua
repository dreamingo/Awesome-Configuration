...
-- Define a tag table which hold all screen tags.
	tags = {
		names  = { "Work |", "File |", "VM |", "Entertainment |", "Music |", "Game |", "Gimp | ", 8, 9 },
...
wicked.register(netwidget, wicked.widgets.net,
			' <span color="#00EC00"> | Net: ${eth0 down} |</span>',
			nil, nil, 3)

--Create a volwidget
volwidget = widget({ type = "textbox" })
vicious.register(volwidget, vicious.widgets.volume, '<span color="#FF8EFF">| VOL: $1% |</span>', 2, "PCM")
...
powwidget = widget({type = "textbox"})
vicious.register(powwidget, vicious.widgets.bat, '<span color="#FF5151"> BAT:{$1%, $2} |</span>', 2,"bat")
--vicious.register(powwidget, vicious.widgets.bat, "BAT $1")
...
--wicked.register(memwidget, wicked.widgets.mem,
	...
	wicked.register(memwidget, wicked.widgets.mem,
				' <span color="#FF9224">Memory: $1%</span>')
	--Create a cpu widget
	cpuwidget = widget({
				type = 'textbox',
				name = 'cpuwidget'
...
wicked.register(cpuwidget, wicked.widgets.cpu,
			' <span  color="#4F9D9D">CPU: $1% |</span>',nil, nil,2 )
...
-- {{{ Key bindings
	globalkeys = awful.util.table.join(
				...
				--awful.key({ "Control", "Mod2"   }, "a", function () awful.util.spawn("deepin-scrot") end),
				...
				awful.key({ modkey }, "x",
					...
					clientkeys = awful.util.table.join(
								...
								--awful.key({ modkey,   }, "#".. 13,      function (c) c:kill()                         end),
